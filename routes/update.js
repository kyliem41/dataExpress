...
router.get('/', function(req, res, next) {
  if(req.session.user){
    ...
    res.render('update', { title: 'Express' ,logIn: "Options", logLink: "/option", pageSize:"height:100%"});
  }else{
    res.render('update', { title: 'Express', logIn: "Log In", logLink: "/logIn", pageSize:"height:100%"});
  }
});
